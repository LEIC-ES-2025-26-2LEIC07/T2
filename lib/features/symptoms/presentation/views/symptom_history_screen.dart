                ...
                child: Container(
                  ...
                  child: Padding(
                    ...
                    child: Column(
                      ...
                      children: [
                        const _IllustrationLine(width: 26),
                        const SizedBox(height: 7),
                        const _IllustrationLine(width: 22),
                        const SizedBox(height: 7),
                        const _IllustrationLine(width: 28),
                        const SizedBox(height: 7),
                        const _IllustrationLine(width: 18),
                      ],
                    ),
                  ),
                ),
...
class _SymptomTimelineCard extends StatelessWidget {
  ...
  @override
  Widget build(BuildContext context) {
    final occurredAt = _formatPortugueseDateTime(log.occurredAt.toLocal());
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          Text(
            _portugueseSymptomLabel(log.symptomType),
...
String _formatPortugueseDateTime(DateTime dateTime) {
  const weekdays = [
    'segunda-feira',
    'terça-feira',
    'quarta-feira',
...
String _portugueseSymptomLabel(String symptomType) {
  const labels = {
  ...
  final normalized = symptomType.trim().toLowerCase();
  final knownLabel = labels[normalized];
