  ...
  Widget build(BuildContext context) {
    return AnimatedBuilder(
      ...
      builder: (context, _) {
        ...
        if (nextDose == null) {
          return const Center(child: Text('No upcoming doses. Good job!'));
        }

        final scheduledTimeLabel = DateFormat.Hm().format(nextDose.scheduledTime);
        final isOverdue = _viewModel.isOverdue;
        final statusColor = isOverdue ? const Color(0xFFE53935) : Colors.black87;
                    ...
                    children: [
                      ...
                      FilledButton(
                        ...
                        style: isOverdue
                            ...
                            : null,
                        child: Text(isOverdue ? 'Log Overdue Dose' : 'Log Dose'),
                      ),
                    ],
                  ),
                ),
